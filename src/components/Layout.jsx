...
const Layout = ({ children }) => {
  ...
  return (
    <div className="relative min-h-screen w-full bg-linear-to-br from-gray-50 to-gray-100 flex items-center justify-center">
      <motion.div
        className="mx-auto w-full min-h-screen bg-white relative overflow-hidden border border-gray-200 shadow-lg"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.9 }}
          onClick={toggleMusic}
          className="fixed top-4 right-4 z-50 bg-white/80 backdrop-blur-xs p-3 rounded-full shadow-lg border border-rose-100/50"
        >
          {isPlaying ? (
        ...
        <AnimatePresence>
          {showToast && (
            ...
            >
              <div className="bg-black/80 text-white transform px-4 py-2 rounded-full backdrop-blur-xs flex items-center space-x-2">
